...
#define  MAINPANEL_STOPBUTTON             4       /* control type: command, callback function: stopButton_CB */
#define  MAINPANEL_RUNBUTTON              5       /* control type: command, callback function: runButton_CB */
#define  MAINPANEL_RING                   6       /* control type: ring, callback function: (none) */
#define  MAINPANEL_BINSRING               7       /* control type: ring, callback function: binsRing_CB */
#define  MAINPANEL_AVGBOX                 8       /* control type: numeric, callback function: (none) */
#define  MAINPANEL_VDCOEFFBOX             9       /* control type: numeric, callback function: (none) */
#define  MAINPANEL_VGCOEFFBOX             10      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_MEASCOUNTDISP          11      /* control type: textMsg, callback function: (none) */
